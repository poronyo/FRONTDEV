...
function Home() {
  return (
    <div className="h-full  flex flex-col justify-between items-center bg-cyan-200 dark:bg-gray-500 ">
      {/* <h1>HomePages </h1> */}
      <div className=" h-full  flex gap-2 p-4 dark:text-amber-100">
        ...
        <div className="h-full flex flex-col justify-start rounded-3xl basis-2/3 bg-cyan-200 dark:bg-gray-700 shadow-2xl ">
