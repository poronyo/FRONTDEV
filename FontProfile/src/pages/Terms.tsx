    ...
    <div className="max-w-screen-xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg dark:prose-invert mx-auto mt-8">
        ...
        <section className="mb-12">
          ...
          <p>
            The materials on WindReact's website are provided on an 'as is'
            basis. WindReact makes no warranties, expressed or implied, and
        ...
        <section className="mb-12">
          ...
          <p>
            In no event shall WindReact or its suppliers be liable for any
            damages (including, without limitation, damages for loss of data or
            profit, or due to business interruption) arising out of the use or
            inability to use the materials on WindReact's website.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p>
            Your use of WindReact's website is also governed by our Privacy
